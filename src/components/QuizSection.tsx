...
const allSteps: QuizStep[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { label: "Transport", description: "Faster routes, business class, private rides", icon: Car },
    ],
  },
  {
    question: "What would you like to avoid?",
    subtitle: "Pick anything you'd rather not deal with — we'll filter it out",
    key: "avoid_preferences",
    type: "options",
    multiSelect: true,
    options: [
      { label: "Long travel time", description: "Keep journeys short", icon: Clock3 },
      { label: "Layovers", description: "Prefer direct routes only", icon: Plane },
      { label: "Crowded places", description: "Skip touristy hotspots", icon: UsersRound },
      { label: "Expensive destinations", description: "Stay value-focused", icon: Banknote },
    ],
  },
  {
    question: "When are you planning to travel?",
    subtitle: "We'll match availability and seasonal pricing",
    key: "travel_timing",
    type: "options",
    options: [
      { label: "Within 7 days", description: "Last-minute escape", icon: Rocket },
      { label: "This month", description: "Plan for the next 30 days", icon: CalendarClock },
      { label: "Next 2–3 months", description: "Comfortable planning window", icon: CalendarCheck },
      { label: "Flexible / No fixed date", description: "Best season recommendations", icon: CalendarOff },
    ],
  },
  {
